      ...
      </div>
      {
        data.length > 0 ? (
          <ul style={{
            ...
            {data.map((account) => {
              return (
                <li style={{ borderBottom: '1px solid darkslategray', padding: 0 }}>
                  <a class={styles} href={`/accounts/${account.accountId}`} style={{ display: 'flex', height: '100%', padding: '2rem', color: 'darkslategray', borderRadius: theme.borderRadius.md }} role="button">
