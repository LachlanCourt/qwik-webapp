...
import { CommandsContainer, CommandsTitle, CommandsHeader, CommandsList, CommandsListItem, CommandsTile } from "./style.css";
          ...
          {data.map((command) => {
            return (
              <li class={`${CommandsListItem}`}>
                ...
                >
                  <div class={`${CommandsTile}`}>{command.commandId}: {command.name}</div>
                </a>
